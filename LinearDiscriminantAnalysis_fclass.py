...
fclass = SelectKBest(f_classif, k = 28) #iterate the k from 1 to 120. The max. accuracy comes at k=28 .
...
#Features selected : ['duration', 'dst_bytes', 'hot', 'num_failed_logins', 'logged_in', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'same_srv_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'service_ftp', 'service_ftp_data', 'service_http', 'service_imap4', 'service_private', 'service_telnet', 'flag_RSTO', 'flag_S0', 'flag_S3', 'flag_SF']
#Classifier trained in 0.828 seconds
