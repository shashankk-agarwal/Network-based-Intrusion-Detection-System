...
fclass = SelectKBest(f_classif, k = 6) #iterate the k from 1 to 120. The max. accuracy comes at k=6 .
...
#Features selected : ['hot', 'num_failed_logins', 'is_guest_login', 'dst_host_same_src_port_rate', 'service_ftp', 'service_ftp_data']
#Classifier trained in 0.155 seconds
