...
chi2f = SelectKBest(chi2, k = 16)#iterate the k from 1 to 120. The max. accuracy comes at k=16 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'hot', 'num_failed_logins', 'is_guest_login', 'count', 'srv_count', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_src_port_rate', 'service_ftp', 'service_ftp_data', 'service_http', 'service_telnet', 'flag_RSTO']
#Classifier trained in 0.533 seconds
#Predicted in 0.008 seconds
#Accuracy is 0.9755.
