...
chi2f = SelectKBest(chi2, k = 13)#iterate the k from 1 to 120. The max. accuracy comes at k=13 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'hot', 'num_failed_logins', 'is_guest_login', 'count', 'srv_count', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_src_port_rate', 'service_ftp', 'service_ftp_data']
#Classifier trained in 0.25 seconds
