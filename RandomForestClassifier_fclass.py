...
fclass = SelectKBest(f_classif, k = 7) #iterate the k from 1 to 120. The max. accuracy comes at k=7 .
...
#Features selected : ['dst_bytes', 'hot', 'num_failed_logins', 'is_guest_login', 'dst_host_same_src_port_rate', 'service_ftp', 'service_ftp_data']
#Classifier trained in 4.299 seconds
#Predicted in 0.532 seconds
#Accuracy is 0.9719.
