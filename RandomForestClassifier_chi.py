...
chi2f = SelectKBest(chi2, k = 12)#iterate the k from 1 to 120. The max. accuracy comes at k=12 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'hot', 'num_failed_logins', 'is_guest_login', 'count', 'srv_count', 'dst_host_count', 'dst_host_srv_count', 'service_ftp', 'service_ftp_data']
#Classifier trained in 5.484 seconds
#Predicted in 0.449 seconds
#Accuracy is 0.9714.
