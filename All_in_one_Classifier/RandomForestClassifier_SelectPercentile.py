#FEATURE_SELECTION ALGORITHM : SelectPercentile
import pandas as pd
import numpy as np
...
selector.fit(X_type,Y_type)
true=selector.get_support()
newcolindex_type=[i for i, x in enumerate(true) if x]
newcolname_type=list( colNames[i] for i in newcolindex_type )
print("Features Selected : ",newcolname_type)

features = newdf[newcolname_type].astype(float)
features1 = newdf_test[newcolname_type].astype(float)
lab = newdf['label']
...
#Features Selected :  ['logged_in', 'count', 'serror_rate', 'srv_serror_rate', 'same_srv_rate', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'service_private', 'flag_S0', 'flag_SF']
#Classifier trained in 5.364 seconds.
#Predicted in 0.882 seconds
#Accuracy is 0.8895.
#Predicted attacks    DoS  Probe  R2L  U2R  normal.
#Actual attacks                                    
#DoS                20668    405    0    0     2497
#Probe                189   1519    0    0      974
#R2L                  141     80   80    1     2754
#U2R                    2      1    2    1       64
#normal.             1022    271  139    0    46481
