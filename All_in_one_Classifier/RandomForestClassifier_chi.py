...
chi2f = SelectKBest(chi2, k = 67) #iterate the k from 1 to 120. The max. accuracy comes at k=67 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'wrong_fragment', 'urgent', 'hot', 'num_failed_logins', 'logged_in', 'num_compromised', 'root_shell', 'num_root', 'num_file_creations', 'num_shells', 'num_access_files', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'Protocol_type_udp', 'service_csnet_ns', 'service_discard', 'service_domain_u', 'service_echo', 'service_eco_i', 'service_ecr_i', 'service_ftp', 'service_ftp_data', 'service_gopher', 'service_http', 'service_imap4', 'service_iso_tsap', 'service_ntp_u', 'service_other', 'service_private', 'service_remote_job', 'service_shell', 'service_smtp', 'service_sql_net', 'service_systat', 'service_telnet', 'service_urp_i', 'flag_OTH', 'flag_REJ', 'flag_RSTO', 'flag_RSTOS0', 'flag_RSTR', 'flag_S0', 'flag_SF', 'flag_SH']
#Classifier trained in 8.701 seconds
#Predicted in 0.752 seconds
#Accuracy is 0.9331.
#Predicted attacks    DoS  Probe  R2L  U2R  normal.
#Actual attacks                                    
#DoS                22243     16    0    0     1311
#Probe                180   1845    0    0      657
#R2L                    0     19  372    4     2661
#U2R                    0      0    6   13       51
#normal.               70    190    2    2    47649
