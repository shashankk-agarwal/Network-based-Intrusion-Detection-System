...
fclass = SelectKBest(f_classif, k = 44) #iterate the k from 1 to 120. The max. accuracy comes at k=112 .
...
#Features selected : ['duration', 'dst_bytes', 'wrong_fragment', 'hot', 'num_failed_logins', 'logged_in', 'root_shell', 'num_shells', 'is_guest_login', 'count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'Protocol_type_udp', 'service_domain_u', 'service_eco_i', 'service_ftp', 'service_ftp_data', 'service_http', 'service_other', 'service_private', 'service_smtp', 'service_telnet', 'flag_REJ', 'flag_RSTR', 'flag_S0', 'flag_SF', 'flag_SH']
#Classifier trained in 1.499 seconds
#Predicted in 0.016 seconds
#Accuracy is 0.9168.
#Predicted attacks    DoS  Probe  R2L  U2R  normal.
#Actual attacks                                    
#DoS                21193    584    4    0     1789
#Probe                112   1679    0    0      891
#R2L                   10     22  460    9     2555
#U2R                    0      1    6   28       35
#normal.              201    144   40   25    47503
