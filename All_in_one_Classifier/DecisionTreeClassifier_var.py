...
variance_threshold.fit(X_type)
true=variance_threshold.get_support()
varcolindex_type=[i for i, x in enumerate(true) if x]
varcolname_type=list(colNames[i] for i in varcolindex_type)
print('Features selected :',varcolname_type)

features = newdf[varcolname_type].astype(float)
features1 = newdf_test[varcolname_type].astype(float)
lab = newdf['label']
...
#Classifier trained in 1.552 seconds
#Predicted in 0.036 seconds
#Accuracy is 0.936.
#Predicted attacks    DoS  Probe  R2L  U2R  normal.
#Actual attacks                                    
#DoS                22381     10    4  136     1039
#Probe                178   1850  171   86      397
#R2L                    0     35  552  424     2045
#U2R                    0      1    4   14       51
#normal.               87    267    6    6    47547
