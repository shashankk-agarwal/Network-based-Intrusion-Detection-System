...
print('Features selected :',s,chicolname_U2R)
...
#Features selected : 5 ['src_bytes', 'dst_bytes', 'root_shell', 'num_file_creations', 'service_telnet']
#Classifier trained in 7.889 seconds
#Predicted in 0.422 seconds
#Accuracy is 0.999.
