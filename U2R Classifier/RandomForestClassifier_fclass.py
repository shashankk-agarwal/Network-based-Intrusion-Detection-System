...
fclass = SelectKBest(f_classif, k = 4) #iterate the k from 1 to 120. The max. accuracy comes at k=4 .
...
#Features selected : ['root_shell', 'num_file_creations', 'num_shells', 'service_telnet']
#Classifier trained in 2.1 seconds
#Predicted in 0.33 seconds
#Accuracy is 0.9993.
