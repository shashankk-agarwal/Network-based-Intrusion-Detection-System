...
fclass = SelectKBest(f_classif, k = 54)
...
print('Features selected :',s ,fclasscolname_U2R)
...
#Features selected : ['duration', 'wrong_fragment', 'urgent', 'hot', 'num_failed_logins', 'logged_in', 'num_compromised', 'root_shell', 'num_root', 'num_file_creations', 'num_shells', 'num_access_files', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'Protocol_type_udp', 'service_auth', 'service_domain_u', 'service_eco_i', 'service_ecr_i', 'service_finger', 'service_ftp', 'service_ftp_data', 'service_http', 'service_ntp_u', 'service_other', 'service_private', 'service_smtp', 'service_telnet', 'service_urp_i', 'flag_REJ', 'flag_RSTO', 'flag_RSTR', 'flag_S0', 'flag_SF']
#Classifier trained in 0.312 seconds
#Predicted in 0.141 seconds
#Accuracy is 0.9715.
