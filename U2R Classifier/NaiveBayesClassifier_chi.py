...
chi2f = SelectKBest(chi2, k = 8)#iterate the k from 1 to 120. The max. accuracy comes at k=8 .
...
#Features selected : ['src_bytes', 'dst_bytes', 'root_shell', 'num_file_creations', 'count', 'dst_host_count', 'dst_host_srv_count', 'service_telnet']
#Classifier trained in 0.155 seconds
#Predicted in 0.048 seconds
#Accuracy is 0.8836.
