...
fclass = SelectKBest(f_classif, k = 1) #iterate the k from 1 to 120. The max. accuracy comes at k=1 .
...
#Features selected : ['root_shell']
#Classifier trained in 0.132 seconds
