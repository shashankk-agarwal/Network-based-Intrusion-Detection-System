...
chi2f = SelectKBest(chi2, k = 4)#iterate the k from 1 to 120. The max. accuracy comes at k=4 .
...
#Features selected : ['src_bytes', 'dst_bytes', 'root_shell', 'num_file_creations']
#Classifier trained in 4.58 seconds
#Predicted in 0.39 seconds
#Accuracy is 0.9994.
