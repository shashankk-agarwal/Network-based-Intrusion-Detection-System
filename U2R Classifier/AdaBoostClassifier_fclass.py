...
fclass = SelectKBest(f_classif, k = 2) #iterate the k from 1 to 120. The max. accuracy comes at k=2 .
...
#Features selected : ['root_shell', 'service_telnet']
#Classifier trained in 7.633 seconds
#Predicted in 0.439 seconds
#Accuracy is 0.9993.
