...
fclass = SelectKBest(f_classif, k = 34) #iterate the k from 1 to 120. The max. accuracy comes at k=34 .
...
#Features selected : ['urgent', 'hot', 'num_failed_logins', 'logged_in', 'num_compromised', 'root_shell', 'num_file_creations', 'num_shells', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_srv_rerror_rate', 'service_ftp', 'service_ftp_data', 'service_http', 'service_private', 'service_smtp', 'service_telnet', 'flag_REJ', 'flag_RSTO', 'flag_S0', 'flag_SF']
#Classifier trained in 1.049 seconds
#Predicted in 0.013 seconds
#Accuracy is 0.999.
