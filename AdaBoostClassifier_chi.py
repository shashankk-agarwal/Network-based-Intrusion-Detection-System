...
chi2f = SelectKBest(chi2, k = 47)#iterate the k from 1 to 120. The max. accuracy comes at k=47 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'urgent', 'hot', 'num_failed_logins', 'logged_in', 'num_compromised', 'root_shell', 'num_root', 'num_file_creations', 'num_shells', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_udp', 'service_domain_u', 'service_ftp', 'service_ftp_data', 'service_http', 'service_imap4', 'service_private', 'service_smtp', 'service_telnet', 'flag_REJ', 'flag_RSTO', 'flag_S0', 'flag_S3', 'flag_SF', 'flag_SH']
#Classifier trained in 26.539 seconds
#Predicted in 1.849 seconds
#Accuracy is 0.9661.
