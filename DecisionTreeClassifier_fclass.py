...
fclass = SelectKBest(f_classif, k = 12) #iterate the k from 1 to 120. The max. accuracy comes at k=12 .
...
#Features selected : ['dst_bytes', 'hot', 'num_failed_logins', 'logged_in', 'is_guest_login', 'dst_host_count', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'service_ftp', 'service_ftp_data', 'service_http', 'service_telnet']
#Classifier trained in 0.317 seconds
#Predicted in 0.006 seconds
#Accuracy is 0.9743.
