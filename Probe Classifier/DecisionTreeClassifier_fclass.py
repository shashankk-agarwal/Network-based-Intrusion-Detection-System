...
fclass = SelectKBest(f_classif, k = 49) #iterate the k from 1 to 120. The max. accuracy comes at k=49 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'wrong_fragment', 'hot', 'logged_in', 'num_access_files', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'service_X11', 'service_auth', 'service_domain_u', 'service_eco_i', 'service_ecr_i', 'service_ftp_data', 'service_gopher', 'service_http', 'service_other', 'service_pm_dump', 'service_smtp', 'service_urp_i', 'service_vmnet', 'flag_OTH', 'flag_REJ', 'flag_RSTOS0', 'flag_RSTR', 'flag_S0', 'flag_SF', 'flag_SH']
#Classifier trained in 0.922 seconds
