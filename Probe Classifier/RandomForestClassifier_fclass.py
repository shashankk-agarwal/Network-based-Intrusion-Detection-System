...
fclass = SelectKBest(f_classif, k = 16) #iterate the k from 1 to 120. The max. accuracy comes at k=16 .
...
#Features selected : ['logged_in', 'count', 'rerror_rate', 'srv_rerror_rate', 'diff_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'service_eco_i', 'service_other', 'flag_RSTR', 'flag_SH']
#Classifier trained in 5.56 seconds
#Predicted in 0.518 seconds
#Accuracy is 0.9882.
