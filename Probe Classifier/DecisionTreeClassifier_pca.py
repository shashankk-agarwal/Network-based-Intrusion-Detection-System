#FEATURE_SELECTION ALGORITHM : Principle Component Analysis
import pandas as pd
import numpy as np
...
feat = pca.fit_transform(X_Probe)
feat_test = pca.transform(X_Probe_test)

from sklearn.tree import DecisionTreeClassifier
clf = DecisionTreeClassifier(random_state=0)
t0 = time()
clf.fit(feat , Y_Probe)
tt = time() - t0
...
acc = accuracy_score(pred, Y_Probe_test)
print ("Accuracy is {}.".format(round(acc,4)))
print(pd.crosstab(Y_Probe_test, pred, rownames=['Actual attacks'], colnames=['Predicted attacks']))

#Classifier trained in 7.023 seconds.
