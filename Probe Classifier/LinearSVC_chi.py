...
chi2f = SelectKBest(chi2, k = 85)#iterate the k from 1 to 120. The max. accuracy comes at k=85 .
chi2f.fit(X_Probe , Y_Probe)
true=chi2f.get_support()
chicolindex_Probe=[i for i, x in enumerate(true) if x]
chicolname_Probe=list(colNames[i] for i in chicolindex_Probe)
print('Features selected :',chicolname_Probe)

features = newdf[chicolname_Probe].astype(float)
features1 = newdf_test[chicolname_Probe].astype(float)
lab = newdf['label']
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'land', 'wrong_fragment', 'hot', 'num_failed_logins', 'logged_in', 'num_compromised', 'root_shell', 'num_root', 'num_file_creations', 'num_shells', 'num_access_files', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'Protocol_type_udp', 'service_X11', 'service_auth', 'service_bgp', 'service_csnet_ns', 'service_discard', 'service_domain_u', 'service_eco_i', 'service_ecr_i', 'service_exec', 'service_finger', 'service_ftp', 'service_ftp_data', 'service_gopher', 'service_http', 'service_imap4', 'service_iso_tsap', 'service_klogin', 'service_kshell', 'service_ldap', 'service_link', 'service_login', 'service_netbios_dgm', 'service_netstat', 'service_nnsp', 'service_ntp_u', 'service_other', 'service_pm_dump', 'service_pop_2', 'service_pop_3', 'service_rje', 'service_shell', 'service_smtp', 'service_sunrpc', 'service_supdup', 'service_telnet', 'service_urp_i', 'service_vmnet', 'service_whois', 'flag_OTH', 'flag_REJ', 'flag_RSTO', 'flag_RSTOS0', 'flag_RSTR', 'flag_S0', 'flag_S1', 'flag_S2', 'flag_SF', 'flag_SH']
#Classifier trained in 16.078 seconds
