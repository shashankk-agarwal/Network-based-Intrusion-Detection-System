...
chi2f = SelectKBest(chi2, k = 64)#iterate the k from 1 to 120. The max. accuracy comes at k=64 .
...
#Features selected : ['duration', 'src_bytes', 'dst_bytes', 'wrong_fragment', 'hot', 'logged_in', 'num_compromised', 'num_root', 'num_file_creations', 'num_access_files', 'is_guest_login', 'count', 'srv_count', 'serror_rate', 'srv_serror_rate', 'rerror_rate', 'srv_rerror_rate', 'same_srv_rate', 'diff_srv_rate', 'srv_diff_host_rate', 'dst_host_count', 'dst_host_srv_count', 'dst_host_same_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_srv_diff_host_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'dst_host_rerror_rate', 'dst_host_srv_rerror_rate', 'Protocol_type_icmp', 'Protocol_type_tcp', 'service_X11', 'service_auth', 'service_bgp', 'service_domain_u', 'service_eco_i', 'service_ecr_i', 'service_finger', 'service_ftp', 'service_ftp_data', 'service_gopher', 'service_http', 'service_imap4', 'service_iso_tsap', 'service_klogin', 'service_link', 'service_netstat', 'service_nnsp', 'service_ntp_u', 'service_other', 'service_pm_dump', 'service_shell', 'service_smtp', 'service_supdup', 'service_urp_i', 'service_vmnet', 'flag_OTH', 'flag_REJ', 'flag_RSTOS0', 'flag_RSTR', 'flag_S0', 'flag_SF', 'flag_SH']
#Classifier trained in 1.062 seconds
