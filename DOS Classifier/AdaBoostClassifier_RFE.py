#FEATURE_SELECTION ALGORITHM : RFE
import pandas as pd
import numpy as np
...
rfe = RFE(estimator=clf, n_features_to_select=118)
rfe.fit(X_DoS, Y_DoS)
true=rfe.support_
...
features = newdf[rfecolname_DoS].astype(float)
features1 = newdf_test[rfecolname_DoS].astype(float)
lab = newdf['label']
