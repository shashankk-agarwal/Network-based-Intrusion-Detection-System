...
rfe = RFE(estimator=clf, n_features_to_select=17)
rfe.fit(X_DoS, Y_DoS)
true=rfe.support_
rfecolindex_DoS=[i for i, x in enumerate(true) if x]
rfecolname_DoS=list(colNames[i] for i in rfecolindex_DoS)
print('Features selected :',rfecolname_DoS)
...
#Features selected : ['src_bytes', 'land', 'wrong_fragment', 'num_compromised', 'same_srv_rate', 'diff_srv_rate', 'dst_host_diff_srv_rate', 'dst_host_same_src_port_rate', 'dst_host_serror_rate', 'dst_host_srv_serror_rate', 'service_ecr_i', 'service_http', 'service_telnet', 'service_tim_i', 'flag_RSTOS0', 'flag_RSTR', 'flag_S0']
#Classifier trained in 0.305 seconds.
