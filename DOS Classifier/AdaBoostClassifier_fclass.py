...
fclass = SelectKBest(f_classif, k = 110) #iterate the k from 1 to 120. The max. accuracy comes at k=110 .
...
#Classifier trained in 18.278 seconds
#Predicted in 1.714 seconds
#Accuracy is 0.982.
